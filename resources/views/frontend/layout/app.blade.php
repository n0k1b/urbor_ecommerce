...
<!-- Mirrored from nouthemes.net/html/farmart/home-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Dec 2020 07:06:33 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    <header class="header">
            ...
            <div class="container">
                <div class="top-bar">
                    ...
                    <div class="top-bar__right">
                        <ul class="nav-top">
                            <li class="nav-top-item contact"><a class="nav-top-link" href="tel:970978-6290"> <i class="icon-telephone"></i><span>Hotline:</span><span class="text-success font-bold">12345678</span></a></li>
        ...
        <div class="ps-header--center header--mobile">
            <div class="container">
                <div class="header-inner">
                    ...
                    <div class="header-inner__center"><a class="logo open" href="index.html">Brand<span class="text-black">logo.</span></a></div>
        ...
        <section class="ps-header--center header-desktop">
            <div class="container">
                <div class="header-inner">
                    <div class="header-inner__left"><a class="logo" href="index.html">Brand<span class="text-black">logo.</span></a>
                        <ul class="menu">
                            <li class="menu-item-has-children has-mega-menu">
                                ...
                                <div class="mega-menu mega-menu-category">
                                    <ul class="menu--mobile menu--horizontal">
                                        ...
                                        <li class="has-mega-menu category-item"><a href="javascript:void(0);">Category1</a><span class="sub-toggle"><i class="icon-chevron-down"></i></span>
                                            <div class="mega-menu">
                                                <div class="mega-anchor"></div>
                                                <div class="mega-menu__column">
                                                    <h4>Sub Category Section 1<span class="sub-toggle"></span></h4>
                                                    <ul class="sub-menu--mega">
                                                        <li> <a href="shop-view-grid.html">Sub Category 1</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 2</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 3</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 4</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 5</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 6</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 7</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 8</a>
                                                        </li>
                                                ...
                                                <div class="mega-menu__column">
                                                    <h4>Sub Category Section 1<span class="sub-toggle"></span></h4>
                                                    <ul class="sub-menu--mega">
                                                        <li> <a href="shop-view-grid.html">Sub Category 9</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 10</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 11</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 12</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 13</a>
                                                        </li>
                                                        <li> <a href="shop-view-grid.html">Sub Category 14</a>
                                                        </li>
                                        ...
                                        <li class="category-item"> <a href="shop-categories.html">Category2</a>
                                        </li>
                                        <li class="category-item"> <a href="shop-categories.html">Category3</a>
                                        </li>
                                        <li class="has-mega-menu category-item"><a href="javascript:void(0);">Category4</a><span class="sub-toggle"><i class="icon-chevron-down"></i></span>
                                            <div class="mega-menu">
                                                <div class="mega-anchor"></div>
                                                <div class="mega-menu__column">
                                                    <h4>Sub Category Section 1<span class="sub-toggle"></span></h4>
                                        ...
                                        <li class="category-item"> <a href="shop-categories.html">Category 4</a>
                                        </li>
                                        <li class="category-item"> <a href="shop-categories.html">Category 5</a>
                                        </li>
                                        <li class="category-item"> <a href="shop-categories.html">Category 6</a>
                                        </li>
                                        <li class="category-item"> <a href="shop-categories.html">Category 7</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <div class="header-inner__center">
                        ...
                        <div class="result-search">
                            <ul class="list-result">
                                <li class="cart-item">
                                    <div class="ps-product--mini-cart"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_18a.jpg" alt="alt" /></a>
                                        <div class="ps-product__content"><a class="ps-product__name" href="product-default.html"><u>Demo Product</a>

                                            <p class="ps-product__meta"> <span class="ps-product__price">TK 6.90</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="cart-item">
                                    <div class="ps-product--mini-cart"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_16a.jpg" alt="alt" /></a>
                                        <div class="ps-product__content"><a class="ps-product__name" href="product-default.html">Demo Product</a>
                                            <p class="ps-product__meta"> <span class="ps-product__price">TK 12.90</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="cart-item">
                                    <div class="ps-product--mini-cart"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_32a.jpg" alt="alt" /></a>
                                        <div class="ps-product__content"><a class="ps-product__name" href="product-default.html">Demo Product</a>
                                            <p class="ps-product__meta"> <span class="ps-product__price">TK 33.49</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="cart-item">
                                    <div class="ps-product--mini-cart"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_6a.jpg" alt="alt" /></a>
                                        <div class="ps-product__content"><a class="ps-product__name" href="product-default.html">Demo Product</a>

                                            <p class="ps-product__meta"> <span class="ps-product__price-sale">TK 4.99</span><span class="ps-product__is-sale">TK 8.99</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="cart-item">
                                    <div class="ps-product--mini-cart"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_22a.jpg" alt="alt" /></a>
                                        <div class="ps-product__content"><a class="ps-product__name" href="product-default.html">Demo Product/a>
                                            <p class="ps-product__meta"> <span class="ps-product__price">TK 12.99</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
            ...
            <div class="mobile-search--content">
                ...
                <div class="mobile-search__result">
                    ...
                    <ul class="list-result">
                        <li class="cart-item">
                            <div class="ps-product--mini-cart"><a href="product-default.html"><img class="ps-product__thumbnail" src="img/products/01-Fresh/01_18a.jpg" alt="alt" /></a>
                                <div class="ps-product__content"><a class="ps-product__name" href="product-default.html"><u>Organic</u> Demo Product</a>
                        ...
                        <li class="cart-item">
                            <div class="ps-product--mini-cart"><a href="product-default.html"><img class="ps-product__thumbnail" src="img/products/01-Fresh/01_6a.jpg" alt="alt" /></a>
                                <div class="ps-product__content"><a class="ps-product__name" href="product-default.html">Demo Product</u> Light Can</a>
        ...
        <div class="ps-home--full-width">
            <div class="container-fluid">
                <div class="row ps-home__banner">
                    <div class="col-12 col-lg-9">
                        <div class="section-slide--default">
                            <div class="owl-carousel" data-owl-auto="false" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
                                <div class="ps-banner"><img class="mobile-only" src="{{asset('assets')}}/frontend/img/slider/home-fullwidth/side-mobile-02.jpg" alt="alt" /><img class="desktop-only" src="{{asset('assets')}}/frontend/img/slider/home-fullwidth/sidebar-02.jpg" alt="alt" />
                                    <div class="ps-content">
                                        <div class="container">
                                            <div class="ps-content-box">
                                                ...
                                                <div class="ps-subtitle">Today Discount </div>
                                                <div class="ps-shopnow"> <a href="shop-view-grid.html">Shop Now<i class="icon-chevron-right"></i></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="ps-banner"><img class="mobile-only" src="{{asset('assets')}}/frontend/img/slider/home-fullwidth/side-mobile-01.jpg" alt="alt" /><img class="desktop-only" src="{{asset('assets')}}/frontend/img/slider/home-fullwidth/sidebar-01.jpg" alt="alt" />
                                    <div class="ps-content">
                                        <div class="container">
                                            <div class="ps-content-box">
                                                <div class="ps-title">Italian Bread Traditions <br/> Macrina Bakeries <br/> <span class='text-success'>Speical Offer.</span></div>
                                                <div class="ps-subtitle">Rustic Bread readly meals for couple</div>
                                                <div class="ps-shopnow"> <a href="shop-view-grid.html">Shop Now<i class="icon-chevron-right"></i></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="ps-banner"><img class="mobile-only" src="{{asset('assets')}}/frontend/img/slider/home-fullwidth/side-mobile-03.jpg" alt="alt" /><img class="desktop-only" src="{{asset('assets')}}/frontend/img/slider/home-fullwidth/sidebar-03.jpg" alt="alt" />
                                    <div class="ps-content">
                                        <div class="container">
                                            <div class="ps-content-box">
                                                <div class="ps-node">Sale off 30%</div>
                                                <div class="ps-title">Fresh Wholesale Produce <br/> From The New York Area.</div>
                                                <div class="ps-subtitle">Only start from</div>
                                                <div class="ps-shopnow"> <a href="shop-view-grid.html">Shop Now<i class="icon-chevron-right"></i></a></div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-lg-3 ps-banner__promo"><a href="shop-view-grid.html"><img src="{{asset('assets')}}/frontend/img/promotion/full-width/promo-01.jpg" alt></a><a href="shop-view-grid.html"><img src="{{asset('assets')}}/frontend/img/promotion/full-width/promo-02.jpg" alt></a></div>
                </div>
                <div class="ps-component ps-component--category">
                    <div class="component__header">
                        <h3 class="component__title">Top Categories Of The Week</h3><a class="component__view" href="shop-categories.html">View all <i class="icon-chevron-right"></i></a>
                    </div>
                    <div class="component__content">
                        <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="15000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="8" data-owl-item-xs="3" data-owl-item-sm="3" data-owl-item-md="5" data-owl-item-lg="8" data-owl-duration="1000" data-owl-mousedrag="on">
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_16a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Fresh </a></div>
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/02-FoodCupboard/02_19a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Food Cupboard </a></div>
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/03-Bakery/03_6a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Barkery </a></div>
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/05-ReadyMeals/05_2a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Ready Meals </a></div>
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/06-SoftDrinks-TeaCoffee/06_9a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Drinks, Tea &amp; Coffee </a></div>
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/07-Beer-WineSpirits/07_1a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Beer, Wine &amp; Spirits </a></div>
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/08-BabyChild/08_5a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Baby &amp; Child </a></div>
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/04-FrozenFoods/04_2a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Frozen Foods </a></div>
                            <div class="ps-category__item"><a href="shop-categories.html"><img class="ps-categories__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_11a.jpg" alt></a><a class="ps-categories__name" href="shop-categories.html">Kitchen &amp; Dining </a></div>
                        </div>
                    </div>
                </div>

                <div class="ps-home--block">
                    <div class="ps-block--promo"><a href="shop-view-grid.html"><img class="desktop-only" src="{{asset('assets')}}/frontend/img/promotion/full-width/promo-03.jpg" alt></a><a href="shop-view-grid.html"><img class="mobile-only" src="{{asset('assets')}}/frontend/img/promotion/full-width/promo-03-mobile.jpg" alt></a></div>
                </div>
                <div class="ps-home--block">
                    <div class="ps-block__header mobile">
                        <div class="ps-block__title">Fresh Foods</div>
                        <div class="ps-block__list">
                            <ul>
                                <li> <a href="shop-categories.html">Best Seller</a>
                                </li>
                                <li class="active"> <a href="shop-categories.html">Meat & Poultry</a>
                                </li>
                                <li> <a href="shop-categories.html">Fruit</a>
                                </li>
                                <li> <a href="shop-categories.html">Vegetables</a>
                                </li>
                                <li> <a href="shop-categories.html">Milk, Butter & Eggs</a>
                                </li>
                                <li> <a href="shop-categories.html">Fish</a>
                                </li>
                                <li class="active"> <a href="shop-categories.html">View all <i class='icon-chevron-right'></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="ps-block__content">
                        <div class="desktop-only ps-block--freshfood">
                            <div class="ps-block__thumbnail"><a href="shop-view-grid.html"><img src="{{asset('assets')}}/frontend/img/promotion/full-width/fresh-food.jpg" alt></a></div>
                            <div class="ps-block--products">
                                <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="6" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="6" data-owl-duration="1000" data-owl-mousedrag="on">
                                    <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_1a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span class="ps-product__price-default">TK 4.49</span>
                                            </p>
                                        </div>
                                        <div class="ps-product__footer">
                                            ...
                                            <div class="ps-product__total">Total: <span>TK 4.49</span>
                                            </div>
                                    ...
                                    <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_2a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__new">New </span>
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span class="ps-product__sale">TK 3.99</span><span class="ps-product__price">TK 4.90</span><span class="ps-product__off">15% Off</span>
                                            </p>
                                        </div>
                                        <div class="ps-product__footer">
                                            <div class="def-number-input number-input safari_only">
                                            ...
                                            <div class="ps-product__total">Total: <span>TK 3.99</span>
                                            </div>
                                            <button class="ps-product__addcart" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</button>
                                            <div class="ps-product__box"><a class="ps-product__wishlist" href="wishlist.html">Wishlist</a><a class="ps-product__compare" href="wishlist.html">Compare</a></div>
                                        </div>
                                    </div>
                                    <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_13a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span class="ps-product__price-default">TK 4.99</span>
                                            </p>
                                        </div>
                                        <div class="ps-product__footer">
                                            <div class="def-number-input number-input safari_only">
                                            ...
                                            <div class="ps-product__total">Total: <span>TK 4.99</span>
                                            </div>
                                            <button class="ps-product__addcart" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</button>
                                            <div class="ps-product__box"><a class="ps-product__wishlist" href="wishlist.html">Wishlist</a><a class="ps-product__compare" href="wishlist.html">Compare</a></div>
                                        </div>
                                    </div>
                                    <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_4a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__offbadge">25% Off </span>
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span class="ps-product__sale">TK 6.90</span><span class="ps-product__price">TK 9.99</span>
                                            </p>
                                        </div>
                                        <div class="ps-product__footer">
                                            <div class="def-number-input number-input safari_only">
                                            ...
                                            <div class="ps-product__total">Total: <span>TK 6.90</span>
                                            </div>
                                            <button class="ps-product__addcart" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</button>
                                            <div class="ps-product__box"><a class="ps-product__wishlist" href="wishlist.html">Wishlist</a><a class="ps-product__compare" href="wishlist.html">Compare</a></div>
                                        </div>
                                    </div>
                                    <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_16a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__offbadge">35% Off </span>
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span class="ps-product__sale">TK 3.90</span><span class="ps-product__price">TK 9.99</span>
                                            </p>
                                        </div>
                                        <div class="ps-product__footer">
                                            <div class="def-number-input number-input safari_only">
                                            ...
                                            <div class="ps-product__total">Total: <span>TK 3.90</span>
                                            </div>
                                            <button class="ps-product__addcart" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</button>
                                            <div class="ps-product__box"><a class="ps-product__wishlist" href="wishlist.html">Wishlist</a><a class="ps-product__compare" href="wishlist.html">Compare</a></div>
                                        </div>
                                    </div>
                                    <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_17a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span class="ps-product__price-default">TK 12.00</span>
                                            </p>
                                        </div>
                                        <div class="ps-product__footer">
                                            <div class="def-number-input number-input safari_only">
                                            ...
                                            <div class="ps-product__total">Total: <span>TK 12.00</span>
                                            </div>
                                            <button class="ps-product__addcart" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</button>
                                            <div class="ps-product__box"><a class="ps-product__wishlist" href="wishlist.html">Wishlist</a><a class="ps-product__compare" href="wishlist.html">Compare</a></div>
                                        </div>
                                    </div>
                                    <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_18a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__stock">Out of stock </span>
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span class="ps-product__sale">TK 6.90</span><span class="ps-product__price">TK 9.99</span><span class="ps-product__off">35% Off</span>
                                            </p>
                                        </div>
                                        <div class="ps-product__footer">
                                            <div class="def-number-input number-input safari_only">
                                    ...
                                    <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_31a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span class="ps-product__price-default">TK 6.99</span>
                                            </p>
                                        </div>
                                        <div class="ps-product__footer">
                                            <div class="def-number-input number-input safari_only">
                                            ...
                                            <div class="ps-product__total">Total: <span>TK 6.99</span>
                                            </div>
                                            <button class="ps-product__addcart" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</button>
                                            <div class="ps-product__box"><a class="ps-product__wishlist" href="wishlist.html">Wishlist</a><a class="ps-product__compare" href="wishlist.html">Compare</a></div>
                                        </div>
                ...
                <div class="ps-home--block">
                    <div class="ps-block__header mobile">
                        <div class="ps-block__title">Kitchen & Dining</div>
                        <div class="ps-block__list">
                            <ul>
                                <li> <a href="shop-categories.html">Most Popular</a>
                                </li>
                                <li> <a href="shop-categories.html">Dining</a>
                                </li>
                                <li> <a href="shop-categories.html">Outdoor Dining</a>
                                </li>
                                <li> <a href="shop-categories.html">Party Tableware</a>
                                </li>
                                <li> <a href="shop-categories.html">Food Storage</a>
                                </li>
                                <li> <a href="shop-categories.html">Utensils</a>
                                </li>
                                <li class="active"> <a href="shop-categories.html">View all <i class='icon-chevron-right'></i></a>
                                </li>
                            </ul>
                    ...
                    <div class="ps-block__content">
                        <div class="desktop-only ps-block--products">
                            <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="7" data-owl-duration="1000" data-owl-mousedrag="on">
                                <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_1a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                    <div class="ps-product__content">
                                ...
                                <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_2a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__new">New </span>
                                    <div class="ps-product__content">
                                ...
                                <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_3a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                    <div class="ps-product__content">
                                ...
                                <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_4a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__offbadge">49% Off </span>
                                    <div class="ps-product__content">
                                        ...
                                        <p class="ps-product-price-block"><span class="ps-product__sale">TK 5.99</span><span class="ps-product__price">TK 6.90</span>
                                        </p>
                                    </div>
                                    <div class="ps-product__footer">
                                        <div class="def-number-input number-input safari_only">
                                        ...
                                        <div class="ps-product__total">Total: <span>TK 5.99</span>
                                        </div>
                                        <button class="ps-product__addcart" data-toggle="modal" data-target="#popupAddToCart"><i class="icon-cart"></i>Add to cart</button>
                                        <div class="ps-product__box"><a class="ps-product__wishlist" href="wishlist.html">Wishlist</a><a class="ps-product__compare" href="wishlist.html">Compare</a></div>
                                    </div>
                                </div>
                                <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_5a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                    <div class="ps-product__content">
                                        ...
                                        <p class="ps-product-price-block"><span class="ps-product__price-default">TK 6.90</span>
                                        </p>
                                    </div>
                                    <div class="ps-product__footer">
                                        <div class="def-number-input number-input safari_only">
                                ...
                                <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_10a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__offbadge">30% Off </span>
                                    <div class="ps-product__content">
                                        ...
                                        <p class="ps-product-price-block"><span class="ps-product__sale">TK 3.99</span><span class="ps-product__price">TK 4.90</span>
                                        </p>
                                    </div>
                                    <div class="ps-product__footer">
                                        <div class="def-number-input number-input safari_only">
                                ...
                                <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_11a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a><span class="ps-badge ps-product__new">New </span>
                                    <div class="ps-product__content">
                                ...
                                <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/09-KitchenDining/09_13a.jpg" alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);" data-toggle="modal" data-target="#popupQuickview"><i class="icon-expand"></i></a>
                                    <div class="ps-product__content">
                ...
                <div class="ps-home--block ps-block--service">
                    <div class="row m-0">
                        <div class="col-6 col-lg-3 p-0">
                            <div class="ps-service__item">
                                <div class="ps-service__icon"><i class="icon-leaf"></i></div>
                                <div class="ps-service__title">100% natural Authentic</div>
                                <div class="ps-service__des">All of our products are made with completely natural farming ingredients.</div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3 p-0">
                            <div class="ps-service__item">
                                <div class="ps-service__icon"><i class="icon-store-24"></i></div>
                                <div class="ps-service__title">27 SUPERMARKETS</div>
                                <div class="ps-service__des">We are your one-stop shop for all nationwide online grocery stores.</div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3 p-0">
                            <div class="ps-service__item">
                                <div class="ps-service__icon"><i class="icon-tags"></i></div>
                                <div class="ps-service__title">FIND daily BEST DEALS</div>
                                <div class="ps-service__des">We work for the customer to make sure that shoppers get the best value for their household</div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3 p-0">
                            <div class="ps-service__item">
                                <div class="ps-service__icon"><i class="icon-folder-heart"></i></div>
                                <div class="ps-service__title">friendly members program</div>
                                <div class="ps-service__des">Start saving straight away with discounts offered on most products store wide.</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="container-fluid quickview-body">
                            <div class="row">
                                <div class="col-12 col-lg-5">
                                    <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-item-xl="1"
                                        data-owl-duration="1000" data-owl-mousedrag="on">
                                        <div class="quickview-carousel"><img class="carousel__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_1a.jpg" alt="alt" /></div>
                                ...
                                <div class="col-12 col-lg-7">
                                    <div class="quickview__product">
                                        <div class="product__header">
                                            <div class="product__title">Demo Product</div>

                                        </div>
                                        <div class="product__content">
                                            <div class="product__price"><span class="sale">Tk 5.49</span><span class="price">TK 6.90</span><span class="off">25% Off</span></div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="cart__content">
                                <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="4" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="2" data-owl-item-lg="4" data-owl-item-xl="4" data-owl-duration="1000" data-owl-mousedrag="on">
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_35a.jpg" alt="alt" /></a>
                                            <div class="ps-product__content">
                                                ...
                                                <p class="ps-product-price-block"><span class="ps-product__sale">TK 8.90</span><span class="ps-product__price">TK 9.90</span><span class="ps-product__off">15% Off</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_16a.jpg" alt="alt" /></a>
                                            <div class="ps-product__content">
                                                ...
                                                <p class="ps-product-price-block"><span class="ps-product__price-default">TK 1.99</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_12a.jpg" alt="alt" /></a>
                                            <div class="ps-product__content">
                                    ...
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_15a.jpg" alt="alt" /></a>
                                            <div class="ps-product__content">
                                                <p class="ps-product__type"><i class="icon-store"></i>Farmart</p><a href="product-default.html">
                                                ...
                                                <p class="ps-product-price-block"><span class="ps-product__sale">TK 6.99</span><span class="ps-product__price">TK 9.90</span><span class="ps-product__off">25% Off</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product-default.html"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/06-SoftDrinks-TeaCoffee/06_3a.jpg" alt="alt" /></a>
                                            <div class="ps-product__content">
                                                ...
                                                <p class="ps-product-price-block"><span class="ps-product__sale">TK 4.90</span><span class="ps-product__price">TK 3.99</span><span class="ps-product__off">15% Off</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="ps-footer--contact">
                <div class="row">
                    <div class="col-12 col-lg-4">
                        ...
                        <p class="telephone">12345678<br>12345678</p>
                        <p> <b>Head office: </b>Office Address</p>
                        <p> <b>Email us: </b><a href="http://nouthemes.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cdbeb8bdbda2bfb98dabacbfa0acbfb9e3aea2a0">[email&#160;protected]</a></p>
                    </div>
                    <div class="col-12 col-lg-4">
                        <div class="row">
            ...
            <div class="ps-footer--service">
                <div class="row">
                    <div class="col-12 col-lg-4">
                        ...
                        <p class="service__app">Get Farmart App to <span class="text-success">get TK 15 coupon</span></p>
                        <div class="service__download"><a href="contact.html"><img src="{{asset('assets')}}/frontend/img/promotion/appStore.jpg" alt></a><a href="contact.html"><img src="{{asset('assets')}}/frontend/img/promotion/googlePlay.jpg" alt></a></div>
                    </div>
                    <div class="col-12 col-lg-4">
                        <table class="table table-bordered">
                            <tr>
                                <td><a href="contact.html"><img src="{{asset('assets')}}/frontend/img/promotion/badges_01.jpg" alt></a></td>
                                <td><a href="contact.html"><img src="{{asset('assets')}}/frontend/img/promotion/badges_02.jpg" alt></a></td>
                                <td><a href="contact.html"><img src="{{asset('assets')}}/frontend/img/promotion/badges_03.jpg" alt></a></td>
                            </tr>
                            <tr>
                                <td><a href="contact.html"><img src="{{asset('assets')}}/frontend/img/promotion/badges_04.jpg" alt></a></td>
                                <td><a href="contact.html"><img src="{{asset('assets')}}/frontend/img/promotion/badges_05.jpg" alt></a></td>
                                <td><a href="contact.html"><img src="{{asset('assets')}}/frontend/img/promotion/badges_06.jpg" alt></a></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-12 col-lg-4">
        ...
        <div class="category__content">
            <ul class="menu--mobile">
                ...
                <li class="menu-item-has-children category-item"><a href="shop-categories.html">Fresh</a><span class="sub-toggle"><i class="icon-chevron-down"></i></span>
                    <ul class="sub-menu">
                        <li> <a href="shop-view-grid.html">Meat & Poultry</a>
                        </li>
                        <li> <a href="shop-view-grid.html">Fruit</a>
                        </li>
                        <li> <a href="shop-view-grid.html">Vegetables</a>
                        </li>
                        <li> <a href="shop-view-grid.html">Milks, Butter & Eggs</a>
                        </li>
                        <li> <a href="shop-view-grid.html">Fish</a>
                        </li>
                        <li> <a href="shop-view-grid.html">Frozen</a>
                        </li>
                        <li> <a href="shop-view-grid.html">Cheese</a>
                        </li>
                        <li> <a href="shop-view-grid.html">Pasta & Sauce</a>
                        </li>
                    </ul>
                </li>
    ...
    <nav class="navigation--mobile">
        ...
        <div class="navigation__content">
            <ul class="menu--mobile">
                <li class="menu-item-has-children"><a href="#">Home</a><span class="sub-toggle"><i class="icon-chevron-down"></i></span>
                    <ul class="sub-menu">
                        <li> <a href="index.html">Home Supermarket</a>
                        </li>
                ...
                <li class="menu-item-has-children"> <a href="product-default.html">Brand</a>
                </li>
        ...
        <div class="navigation__footer">
            <ul class="menu--icon">
                ...
                <li class="footer-item"><a class="footer-link" href="#"><i class="icon-telephone"></i><span>HOTLINE: <span class='text-success'>12345678</span> (Free)</span></a></li>
            </ul>
        </div>
    </nav>
