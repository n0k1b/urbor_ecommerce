							...
							<div class="card-body">
                                ...
                                @csrf
									<div class="row">
										...
										{{-- <div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group">
												<label class="form-label">Domain Image(optional)</label>
												<input type="file" name="image"  class="form-control dropify" data-default-file=""  accept="image/*" multiple required>
											</div>
										</div> --}}
