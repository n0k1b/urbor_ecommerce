...
<body></body>
    ...
    ***********************************-->
    ...
    <script src="{{asset('assets')}}/admin/vendor/morris/morris.min.js?{{time()}}"></script>


	<!-- Chart piety plugin files -->
    <script src="{{asset('assets')}}/admin/vendor/peity/jquery.peity.min.js?{{time()}}"></script>


		<!-- Demo scripts -->
    <script src="{{asset('assets')}}/admin/js/dashboard/dashboard-2.js?{{time()}}"></script>

	<!-- Svganimation scripts -->
    <script src="{{asset('assets')}}/admin/vendor/svganimation/vivus.min.js?{{time()}}"></script>
    <script src="{{asset('assets')}}/admin/vendor/svganimation/svg.animation.js?{{time()}}"></script>
